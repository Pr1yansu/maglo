...
export const DashboardPage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Dashboard"
        description="Access your Maglo dashboard to view analytics, manage users, and control your application settings. Secure and user-friendly interface."
        keywords="dashboard, analytics, user management, maglo dashboard"
        url="/dashboard"
        noindex={true}
      />
