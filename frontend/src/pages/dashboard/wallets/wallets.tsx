  ...
  return (
    <>
      ...
      <div className="min-h-full">
        <div className="p-4 py-8 lg:flex lg:gap-6">
          <section
            ref={leftSideRef}
            className="lg:w-1/2 opacity-0 mb-8 lg:mb-0"
          ...
          <section
            ref={rightSideRef}
            className="lg:w-1/2 p-5 opacity-0 flex flex-col min-h-0"
          ...
          >
            ...
            <div className="py-2 space-y-2 flex-1 min-h-0 overflow-auto">
              <h6
              ...
              <div
                ...
                className="rounded-md border opacity-0 max-h-[300px] overflow-auto"
              >
              ...
              {activeTab === "All" && (
                <div className="py-2 space-y-2">
                  ...
                  <div
                    ...
                    className="rounded-md border opacity-0 max-h-[200px] overflow-auto"
                  >
                    <div className="px-4 py-2">
