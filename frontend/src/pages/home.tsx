    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <p className="text-lg mb-4">
                This paragraph uses Lato font family for body text. It provides excellent readability
                and a clean, modern appearance for all content text throughout the application.
            </p>

            <h3 className="text-2xl font-medium mb-3">Features Overview</h3>
            <p className="mb-4">
                All heading tags (h1, h2, h3, h4, h5, h6) now use the Roboto font family, which provides
                strong visual hierarchy and excellent legibility for titles and section headers.
            </p>
            ...
            <p className="text-sm text-gray-600">
                The font configuration ensures consistent typography across the entire application
                while maintaining optimal performance through Google Fonts optimization.
            </p>

            <h6 className="text-base font-medium mt-4">Small Heading Example</h6>
            <p className="text-xs text-gray-500 mt-2">
                This demonstrates the smallest heading level with accompanying small text.
            </p>
        </div>
    )
}
